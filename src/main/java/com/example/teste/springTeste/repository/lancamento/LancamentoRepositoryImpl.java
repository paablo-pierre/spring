...
import com.example.teste.springTeste.model.Categoria_;
import com.example.teste.springTeste.model.Lancamento;
import com.example.teste.springTeste.model.Lancamento_;
import com.example.teste.springTeste.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRespositoryQuery {
    ...
    public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
        ...
        criteria.select(builder.construct(ResumoLancamento.class, root.get(Lancamento_.codigo), root.get(Lancamento_.descricao),
                ...
                root.get(Lancamento_.tipo), root.get(Lancamento_.categoria).get(Categoria_.nome), root.get(Lancamento_.pessoa).get(Pessoa_.nome)));
